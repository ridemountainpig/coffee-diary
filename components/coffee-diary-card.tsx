...
import { BookImage, CalendarDays, Map } from "lucide-react";
            ...
            >
                ...
                <Dialog.Root>
                    <Dialog.Trigger asChild>
                        <button className="mt-4 flex h-fit w-fit items-center py-1 px-1.5 rounded-lg border-3 border-[#967253]">
                            <BookImage
                                size={20}
                                color="#967253"
                                strokeWidth={3}
                    ...
                    <Dialog.Portal>
                        <Dialog.Content className="w-[340px] h-[530px] flex justify-center items-center fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] rounded-2xl bg-serenade-600">
                            <CoffeeDiary
                                url={`https://coffee-diary.com/api/${name}?date=${date}`}
                            ></CoffeeDiary>
                        </Dialog.Content>
                    </Dialog.Portal>
                </Dialog.Root>
